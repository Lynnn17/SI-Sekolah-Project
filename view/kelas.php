        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include "V_topbarsmk.php" ?>
                ...
                <div class="container-fluid">
                    ...
                    $data = $conn->query("select * from angkatan");
                if ($data=== FALSE) {
                    die(mysqli_error());
                }
                $no = 1;
                while($d = mysqli_fetch_assoc($data)){ ?>
                    <i><?php echo $d['tahun_angkatan'];?></i>
                    <?php } ?>
                            </h6>
                        </div>
                        <div class="card-body">
        ...
        "columnDefs": [
        {
          ...
          },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return `<a href="<?= BASE_URL ?>view/siswa.php?kelas=${row.id_kelas}">${data}</a>`;
                },
                "targets": 1
            },
            <?php if ($_SESSION['jabatan'] == "admin") {?>
