...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">AUDITOR</div>
            </a>
                ...
                <div id="collapseTwo" class="collapse " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item  <?php if (isset($_GET["angkatan"])){echo "active"; }?> 
                            <?php if (isset($_GET["kelas"])){echo "active"; }?>"
                            href="<?= BASE_URL; ?>view/data_angkatanaudit.php?angkatan">Murid</a>
                           
                        <a class="collapse-item <?php if (isset($_GET["jurusan"])){echo "active"; }?> 
                            <?php if (isset($_GET["guru"])){echo "active"; }?>" 
                            href="<?= BASE_URL; ?>view/jurusanaudit.php?jurusan">Guru</a>
                            <a class="collapse-item <?php if (isset($_GET["user"])){echo "active"; }?> 
                            <?php if (isset($_GET["user"])){echo "active"; }?>" 
                            href="<?= BASE_URL; ?>view/useraudit.php?user">User</a>
                    </div>
                </div>
            </li>
           <?php } ?>
            <!-- Nav Item - Pages Collapse Menu -->
             ...
             <li class="nav-item <?php if (isset($_GET["cek"])){echo "active"; }?>">
                <a class="nav-link " href="<?= BASE_URL; ?>view/pengecekan.php?cek" data-toggle="" data-target="#collapseTwo"
