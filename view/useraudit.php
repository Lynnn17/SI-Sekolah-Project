...
<script type="text/javascript">
    ...
    function simpanData(){
        ...
        var url           = "<?= BASE_URL; ?>back/useraudit/insert_user.php";

        if(status == "UPDATE"){
            url           = "<?= BASE_URL; ?>back/useraudit/update_user.php"
        }
        if (usr == "") {
    ...
    function handleHapus(id_user) {
        ...
        if (result.isConfirmed) {
            ...
            'success'
                 ...
                 $.ajax({
                    url:"<?= BASE_URL; ?>back/useraudit/delete_user.php",
                    method:"post",
                    data:{
                        id_user:id_user
                    },
    ...
    function initTable() {
       ...
       "paging" : true,
        "ajax": "<?= BASE_URL; ?>back/useraudit/select_all.php",
        "columns": [
            { "data": "id_user" },
             <?php if ($_SESSION['jabatan'] == "admin") {?>
            { "data": "username" },
