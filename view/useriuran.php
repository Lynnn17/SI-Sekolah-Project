...
<script type="text/javascript">
    ...
    function simpanData(){
        ...
        var url           = "<?= BASE_URL; ?>back/useriuran/insert_user.php";

        if(status == "UPDATE"){
            url           = "<?= BASE_URL; ?>back/useriuran/update_user.php"
        }
        if (usr == "") {
    ...
    function handleHapus(id_user) {
        ...
        if (result.isConfirmed) {
            ...
            'success'
                 ...
                 $.ajax({
                    url:"<?= BASE_URL; ?>back/useriuran/delete_user.php",
                    method:"post",
                    data:{
                        id_user:id_user
                    },
    ...
    function initTable() {
       ...
       "paging" : true,
        "ajax": "<?= BASE_URL; ?>back/useriuran/select_all.php",
        "columns": [
            { "data": "id_user" },
            <?php if ($_SESSION['jabatan'] == "admin") {?>
            { "data": "username" },
