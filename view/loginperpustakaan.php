...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- Outer Row -->
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block text-center pt-4"><br><img src="<?= BASE_URL; ?>assets/img/logosmk.png" width="200" height ="200"><hr><h3>PERPUSTAKAAN SMK NEGERI PURWOSARI</h3><h6>Jl. Ngambon No.Km. 1.5, Pojok, Purwosari, Kabupaten Bojonegoro, Jawa Timur 62161 </h6></div>
    ...
    <script >
        function getLogin () {
            ...
            $.ajax({
                url:"<?= BASE_URL; ?>/back/login/handle_loginperpustakaan.php/",
                type:"post",
                data:{
                    username:username,
                    password:password
                ...
                success:(res) => {
                    ...
                    if (res == "Username tidak ditemukkan") {
                        ...
                        location.replace ("<?= BASE_URL; ?>view/dashboard-perpus.php?home")
                    }
                },
                error: () => {
