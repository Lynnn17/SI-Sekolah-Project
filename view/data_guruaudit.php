    ...
    <div class="modal-content">
      ...
      <div class="form-group">
            ...
            <!-- <label> ID JURUSAN :</label> -->
                <input type="hidden" class="form-control form-control-user" id="id_jurusan" placeholder="">
        </div>
        </div>
      <div class="modal-footer">
...
function simpanExcel(){
       ...
       form_data.set("id_jurusan", id_jurusan);
        
        var url           = "<?= BASE_URL; ?>back/guru/insert_excel.php";
        // if (file == "") {
