...
$spreadsheet->setActiveSheetIndex(0)->setCellValue('A1', 'Laporan Record Pembayaran '.$tgla1.' sampai '.$tgla2);
...
INNER JOIN kelas ON siswa.id_kelas= kelas.id_kelas WHERE siswa.id_siswa = '$id_siswa' 
AND pembayaranrecord.nama_pembayaran LIKE '$nama_pembayaran' 
AND pembayaranrecord.tanggal_dibayar BETWEEN '$tgl1' AND '$tgl2'");
...
siswa.nama_siswa,kelas.nama_kelas,pembayaranrecord.status,pembayaran.total_pembayaran,
pembayaranrecord.tanggal_dibayar,pembayaranrecord.total_dibayar,pembayaranrecord.dibayar,
pembayaranrecord.admin
FROM pembayaranrecord
...
$writer->save('../../assets/uploads/report/pembayaran/'.'Report Record Pembayaran '.date('d-m-Y').'.xlsx');
header('location:../../assets/uploads/report/pembayaran/'.'Report Record Pembayaran '.date('d-m-Y').'.xlsx');
?>
