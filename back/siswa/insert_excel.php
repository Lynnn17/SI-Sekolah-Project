...
$worksheet 				= $spreadsheet->getActiveSheet();
    ...
    $kolom_str                  = array("nisn","nama_siswa","alamat","no_tlpn","jenis_kelamin");
    // array output
    $hasil                  = array();
    ...
    include '../koneksi.php';
    foreach($hasil as $h) {
        $sql = $conn->query("INSERT INTO siswa(id_kelas,nisn,nama_siswa,alamat,no_tlpn,jenis_kelamin) VALUES 
        ('$id_kelas',\"".$h['nisn']."\",\"".$h['nama_siswa']."\",\"".$h['alamat']."\",\"".$h['no_tlpn']."\",\"".$h['jenis_kelamin']."\")");
    }
